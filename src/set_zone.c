...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/01/15 19:00:49 by mmoullec          #+#    #+#             */
/*   Updated: 2019/01/15 19:04:27 by mmoullec         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static inline size_t		set_tiny_zone(void)
{
	size_t				r;
	size_t				q;
	size_t				size;
...
static inline size_t		set_small_zone(void)
{
	size_t				q;
	size_t				r;
	size_t				size;
...
static inline t_zone		*set_zone_(t_zone **zone, size_t size)
{
	(*zone)->next = NULL;
	(*zone)->previous = NULL;
