...
/*   Updated: 2019/01/15 19:25:36 by mmoullec         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "malloc.h"

void	printf_chunk_infos(t_chunk *chunk, unsigned long long *total)
{
...
void	printf_zone_infos(t_zone **zone, unsigned long long *total, int type)
{
	t_chunk		*chunk;
	size_t		size;
	t_zone		*z;
